...
1. Clicking "Clear read history" in the extension panel
2. Removing the extension from Chrome (Settings > Extensions)

## Changes to This Policy

If this privacy policy changes, the updated policy will be posted here with a new "Last updated" date.
